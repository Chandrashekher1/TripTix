    ...
    <div className=''>
        ...
        <div className='bg-white py-4 my-8'>
          <div className='md:w-[60vw] md:mx-auto mx-4 flex flex-col items-center justify-center my-auto'>
               <h1 className='font-bold text-3xl md:text-4xl text-center my-4'>Why choose <span className='text-[#23a983]'>TripTix?</span></h1>
                <p className='text-gray-500 text-center text-xl'>Experience the future of bus travel with our cutting-edge features designed to make your journey smooth and worry-free.</p>
          </div>
          <WhyChoose/>
        </div>
        ...
        <div className='bg-[#f5fefa] py-24'>
            <h1 className='font-semibold text-4xl text-center '>What Our <span className='text-[#23a983] font-bold'>Riders</span> Say</h1>
