...
const OfferCard = () => {
  return (
    <div className='mx-4'>
        <div className='flex flex-col justify-center items-center border border-gray-300 bg-white px-6 py-4 shadow rounded-md hover:border-blue-700 hover:shadow-xl'>
        ...
        <div className='flex flex-col justify-center items-center border border-gray-300 bg-white px-6 py-4 shadow rounded-md hover:border-blue-700 hover:shadow-xl my-6'>
