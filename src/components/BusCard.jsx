            ...
            <div className="p-4">
              ...
              <div className='flex justify-between my-4'>
                <p className='flex flex-col text-white font-bold'>
                  ...
                  <span className='text-gray-400 font-normal text-sm'>Departure</span>
                </p>
                <p className='flex flex-col text-white font-bold'>
                  {formatTime(bus?.arrivalTime)}
                  <span className='text-gray-400 font-normal text-sm'>Arrival</span>
                </p>
              </div>
              <div className="flex flex-wrap my-2">
                {bus.isAc && <p className="bg-gray-800 text-gray-400 text-sm rounded-full px-2 py-1 mr-2">AC</p>}
                {bus.isSleeper && <p className="bg-gray-800 text-gray-400 text-sm rounded-full px-2 py-1 mr-2">Sleeper</p>}
                {bus.isSeater && <p className="bg-gray-800 text-gray-400 text-sm rounded-full px-2 py-1 mr-2">Seater</p>}
                {bus.isWifi && <p className="bg-gray-800 text-gray-400 text-sm rounded-full px-2 py-1 mr-2">WiFi</p>}
              </div>
