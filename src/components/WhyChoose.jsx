    ...
    <div className="px-4 py-12">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
        <div className="bg-[#060e23] md:p-6 p-4 rounded-xl border border-gray-800 hover:-translate-y-1 hover:z-10 transition-all duration-300">
          ...
          <h3 className="text-white text-xl font-semibold md:my-4 my-2">Live Seat Locking</h3>
        ...
        <div className="bg-[#060e23] md:p-6 p-4 rounded-xl border border-gray-800 hover:-translate-y-1 hover:z-10 transition-all duration-300">
          ...
          <h3 className="text-white text-xl font-semibold md:my-4 my-2">ChatBot Help</h3>
        ...
        <div className="bg-[#060e23] md:p-6 p-4 rounded-xl border border-gray-800 hover:-translate-y-1 hover:z-10 transition-all duration-300">
          ...
          <h3 className="text-white text-xl font-semibold md:my-4 my-2">Real-time Bus Tracking</h3>
        ...
        <div className="bg-[#060e23] md:p-6 p-4 rounded-xl border border-gray-800 hover:-translate-y-1 hover:z-10 transition-all duration-300">
          ...
          <h3 className="text-white text-xl font-semibold md:my-4 my-2">Secure Payment Gateway</h3>
        ...
        <div className="bg-[#060e23] md:p-6 p-4 rounded-xl border border-gray-800 hover:-translate-y-1 hover:z-10 transition-all duration-300">
          ...
          <h3 className="text-white text-xl font-semibold md:my-4 my-2">Secure Login & Signup</h3>
        ...
        <div className="bg-[#060e23] md:p-6 p-4 rounded-xl border border-gray-800 hover:-translate-y-1 hover:z-10 transition-all duration-300">
          ...
          <h3 className="text-white text-xl font-semibold md:my-4 my-2">Easy Cancellation</h3>
